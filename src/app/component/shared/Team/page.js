          ...
          <div className="grid gap-8 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 lg:pl-4">
              ...
              <p className="text-neutral-600 text-sm sm:text-base leading-relaxed font-medium">
                মাহমুদ আর্ট এন্ড প্রেস-এর প্রতিষ্ঠাতা হিসেবে তিনি ডিজিটাল প্রিন্টিং, লাইটিং সাইনবোর্ড, কর্পোরেট ব্র্যান্ডিং এবং প্রমোশনাল মার্কেটিং ম্যাটেরিয়াল তৈরিতে দীর্ঘদিন ধরে কাজ করে আসছেন। তার দূরদর্শী নেতৃত্বে আমাদের পুরো টিম কর্পোরেট ও বাণিজ্যিক প্রতিষ্ঠানসমূহের জন্য বিশ্বস্ত ও দীর্ঘস্থায়ী প্রোডাকশন সেবা প্রদান করে যাচ্ছে।
              </p>
