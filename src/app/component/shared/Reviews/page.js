  ...
  const reviews = [
    {
      ...
      message:
        " 'মাহমুদ আর্ট এন্ড প্রেস' আমাদের কর্পোরেট ইভেন্টের উপস্থিতিকে সম্পূর্ণ নতুন মাত্রা দিয়েছে। ব্যানার ডিজাইনের মান, রঙের নিখুঁত ব্যবহার এবং দ্রুত ডেলিভারি সত্যিই প্রশংসনীয়।",
    },
    {
      name: "করিম উদ্দিন",
